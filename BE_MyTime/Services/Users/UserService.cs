...
namespace BE_MyTime.Services.Users
{
    public class UserService : IUserService
    {
            ...
            UpdateUserSettingRequest request)
        {
            ...
            setting.EnergyProfileJson = string.IsNullOrWhiteSpace(request.EnergyProfileJson)
                ? null
                : request.EnergyProfileJson.Trim();
        ...
        private static UserSettingResponse ToSettingResponse(UserSetting setting)
        {
            return new UserSettingResponse
            {
                ...
                EnergyProfileJson = setting.EnergyProfileJson
            };
        }
    }
}
