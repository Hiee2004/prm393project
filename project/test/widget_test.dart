...
void main() {
  testWidgets('Home screen focuses on the MyTime workflow', (tester) async {
    ...
    expect(find.text('Focus on one task'), findsOneWidget);
    expect(find.text('Start Focus Time'), findsWidgets);
    await tester.scrollUntilVisible(
      find.text('Main workflow'),
      200,
      scrollable: find.byType(Scrollable).first,
    );
    expect(find.text('Main workflow'), findsOneWidget);
  });
